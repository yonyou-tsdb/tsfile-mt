...
public class ChunkGroupMetaInfo {
    ...
    public ChunkGroupMetaInfo(byte marker, List<IChunkMetadata> chunkMetadataList, List<ChunkHeader> chunkHeaderList, List<long[]> timeBatch, IChunkMetadata alignedTimeChunkMetadata, List<IChunkMetadata> alignedValueChunkMetadata) {
        this.marker = marker;
